...
class Game {
        ...
        if (
          ...
          if (current.element === Element.Sand) {
            ...
            if (this.getNeighbour(x, y, 0, 1).element === Element.Empty) {
              ...
              this.getNeighbour(x, y, 0, 1).element === Element.Water
            ) {
              ...
              this.getNeighbour(x, y, direction, 1).element === Element.Empty
            ) {
            ...
            if (this.getNeighbour(x, y, 0, 1).element === Element.Empty) {
              ...
              this.getNeighbour(x, y, direction, 0).element === Element.Empty
            ) {
            ...
            if (!current.dispenses) {
              ...
              if (this.getNeighbour(x, y, 0, -1).element !== Element.Empty) {
                ...
                this.getNeighbour(x, y, -1, 0).element !== Element.Empty
              ) {
                ...
                this.getNeighbour(x, y, 0, 1).element !== Element.Empty
              ) {
                if (this.getNeighbour(x, y, 0, 1).element === Element.Tap) {
                  current.dispenses = this.getNeighbour(x, y, 0, 1).dispenses;
                } else {
            ...
            if (this.getNeighbour(x, y, 0, -1).element === Element.Water) {
              ...
              this.getNeighbour(x, y, -1, 0).element === Element.Water
            ) {
            ...
            if (this.getNeighbour(x, y, 0, -1).element === Element.Plant) {
              ...
              this.getNeighbour(x, y, -1, 0).element === Element.Plant
            ) {
              ...
              this.getNeighbour(x, y, 0, 1).element === Element.Plant
            ) {
              this.setParticle(x, y, 0, 1, new Particle(Element.Fire));
            }
          }
  ...
  draw() {
    ...
    this.context.fillText(
      this.fps + "/" + Math.round(1000 / this.options.interval) + " FPS",
      10,
      25
    );
  }
